...
class TextCNN(nn.Module):
    def __init__(self, config, vocab_size, embed_size, word_embeddings, num_channels=1):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv1d(in_channels=embed_size, out_channels=self.config.num_channels, kernel_size=self.config.kernel_size[0]),
            nn.ReLU(),
